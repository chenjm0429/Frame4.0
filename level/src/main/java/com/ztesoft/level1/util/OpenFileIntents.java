...
/**
 * 文件名称 : OpenFileIntents
 * <p>
 * 作者信息 : chenjianming
 * <p>
 * 文件描述 : 不同格式文件默认打开方式
 * <p>
 * 创建时间 : 2017/5/22 16:58
 * <p>
 */
public class OpenFileIntents {
    ...
    public static Intent openFile(String filePath) {
        ...
        if (filePath.endsWith(".pdf")) {
            ...
            myIntent.setDataAndType(uri, "application/vnd.openxmlformats-officedocument" +
                    ".spreadsheetml.sheet");
        ...
        } else if (filePath.endsWith(".mp4") || filePath.endsWith(".3gp") || filePath.endsWith("" +
                ".avi")) {
            myIntent.putExtra("oneshot", 0);
            myIntent.putExtra("configchange", 0);
            myIntent.setDataAndType(uri, "video/*");
            
        } else if (filePath.endsWith(".mp3") || filePath.endsWith(".wav") || filePath.endsWith("" +
                ".mpga")) {
            myIntent.putExtra("oneshot", 0);
            myIntent.putExtra("configchange", 0);
