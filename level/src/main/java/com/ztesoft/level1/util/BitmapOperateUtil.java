...
public class BitmapOperateUtil {
    private final static String TAG = "TakeScreenPic";
...
//			Log.e(TAG, ex.toString());
     ...
     * @return
     */
    public static Bitmap getBitmapFormRes(Context ctx, int resId) {
        Bitmap bb = BitmapFactory.decodeResource(ctx.getResources(), resId);
        return bb;
    }
