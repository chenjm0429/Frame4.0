...
public class UploadThread implements Runnable {
	 ...
	 */
	public UploadThread(String serverUrl, String filePath, String staffId, Handler sh, String uploadPath) {
	...
	public void run() {
		...
		try {
			URL url = new URL(serverUrl + "/jsp/file_upload.jsp?fileName=" + ff.getName() + "&filePath=" + uploadPath);// 文件上传路径和名称
