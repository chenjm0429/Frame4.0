...
//            conn.setRequestProperty("session", header);
            ...
            if (1 == encryFlag) {
                input = TranspositionHelp.encrypt(input, encryKey);
            } else if (2 == encryFlag) {
                input = DESHelp.encrypt(input, encryKey);
            } else if (3 == encryFlag) {
                input = Base64Help.encrypt(input);
            } else if (4 == encryFlag) {
...
//                header = conn.getHeaderField("session");
            ...
            if (1 == encryFlag) {
                str = TranspositionHelp.decrypt(str, encryKey);
            } else if (2 == encryFlag) {
                str = DESHelp.decrypt(str, encryKey);
            } else if (3 == encryFlag) {
                str = Base64Help.decrypt(str);
            } else if (4 == encryFlag) {
