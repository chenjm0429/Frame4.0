 ...
 */
public class VScrollFrame extends ViewGroup {
     ...
     * @param context
     */
    public VScrollFrame(Context context) {
        super(context);
    ...
    public void setCurPageNum(int viewIndex) {
        mCurrentScreen = Math.max(0, Math.min(viewIndex, getChildCount() - 1));

        if (pageListener != null) {
            pageListener.page(mCurrentScreen);
        }
    }
