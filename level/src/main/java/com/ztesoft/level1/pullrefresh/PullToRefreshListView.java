...
/**
 * 文件名称 : PullToRefreshListView
 * <p>
 * 作者信息 : chenjianming
 * <p>
 * 文件描述 : 这个类实现了ListView下拉刷新，上加载更多和滑到底部自动加载
 * <p>
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
     ...
     * 用于滑到底部自动加载的Footer
     */
    private FreshLayout mLoadMoreFooterLayout;
    /**
     * 滚动的监听器
     */
    ...
    public void setHasMoreData(boolean hasMoreData) {
        if (!hasMoreData) {
            ...
            FreshLayout footerLoadingLayout = getFooterLoadingLayout();
    ...
    private boolean hasMoreData() {
        if ((null != mLoadMoreFooterLayout) && (mLoadMoreFooterLayout.getState() == 
                ILoadingLayout.State.NO_MORE_DATA)) {
            return false;
        }
