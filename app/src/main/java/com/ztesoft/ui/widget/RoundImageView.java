...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.round_imageview);
        mBorderThickness = a.getDimensionPixelSize(R.styleable.round_imageview_border_thickness, 0);
        mBorderOutsideColor = a.getColor(R.styleable.round_imageview_border_outside_color, defaultColor);
        mBorderInsideColor = a.getColor(R.styleable.round_imageview_border_inside_color, defaultColor);
    }
