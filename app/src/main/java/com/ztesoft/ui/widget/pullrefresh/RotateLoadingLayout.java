...
/**
 * 文件名称 : RotateLoadingLayout
 * <p>
 * 作者信息 : chenjianming
 * <p>
 * 文件描述 : 这个类封装了下拉刷新的布局
 * <p>
 * 创建时间 : 2017/3/24 15:05
 * <p>
 */
public class RotateLoadingLayout extends FreshLayout {
    /**
     * 旋转动画的时间
     */
    ...
    private void init(Context context) {
        ...
        mArrowImageView.setImageResource(R.drawable.rotate_image_default);

        float pivotValue = 0.5f; // SUPPRESS CHECKSTYLE
        float toDegree = 720.0f; // SUPPRESS CHECKSTYLE
        mRotateAnimation = new RotateAnimation(0.0f, toDegree, Animation.RELATIVE_TO_SELF,
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout
                .view_pull_to_refresh_header, null);
        return container;
    }
