 ...
 * <p>
 */
public class FooterLoadingLayout extends FreshLayout {
    /**
     * 进度条
     */
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.view_pull_to_load_footer, 
                null);
        return container;
    }
