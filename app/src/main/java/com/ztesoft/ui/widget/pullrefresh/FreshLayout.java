 ...
 * 作者信息 : chenjianming
 * <p>
 * 文件描述 : 这个类定义了Header和Footer的共通行为
 * <p>
 * 创建时间 : 2017/3/24 14:54
 * <p>
 */
public abstract class FreshLayout extends FrameLayout implements ILoadingLayout {
     ...
     */
    public FreshLayout(Context context, AttributeSet attrs, int defStyle) {
