...
import com.ztesoft.ui.widget.pullrefresh.ILoadingLayout.State;

/**
 * 文件名称 : PullToRefreshBase
 * <p>
 * 作者信息 : chenjianming
 * <p>
 * 文件描述 : 这个实现了下拉刷新和上拉加载更多的功能
 * <p>
 * 创建时间 : 2017/3/24 14:56
 * <p>
 */
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
     ...
     * 下拉刷新的布局
     */
    private FreshLayout mHeaderLayout;
    /**
     * 上拉加载更多的布局
     */
    private FreshLayout mFooterLayout;
    /**
     * HeaderView的高度
     */
    ...
    @Override
    public FreshLayout getHeaderLoadingLayout() {
        return mHeaderLayout;
    }

    @Override
    public FreshLayout getFooterLoadingLayout() {
     ...
     */
    protected FreshLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
     ...
     * @return LoadingLayout对象
     */
    protected FreshLayout createFooterLoadingLayout(Context context, AttributeSet attrs) {
    ...
    protected void addHeaderAndFooter(Context context) {
        ...
        final FreshLayout headerLayout = mHeaderLayout;
        final FreshLayout footerLayout = mFooterLayout;
    ...
    private void smoothScrollTo(int newScrollValue, long duration, long delayMillis) {
        ...
        if (post) {
            mSmoothScrollRunnable = new SmoothScrollRunnable(oldScrollValue, newScrollValue, 
                    duration);
        }
